package DSA.nonlinear.graphs.algos;
...
public class DijkstrasPQMInHeap {
    public static List<Integer> dijkstra(int V,List<List<Pair>>adj,int S){
        ...
        // if we get a better distance update where this process is called "Relaxation"
        while(!pq.isEmpty()){
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Shortest Distance node is: "+S+":");
        for(int i=0;i<V;i++)
        {
