...
public class TreeNode {
    ...
    TreeNode right; // the reference top the right child
    TreeNode(int data) {
        this.data = data;
        this.left = this.right = null; // initially the nodes ahs no children
    }
    ...
    public static void main(String[] args) {
        // rule for constructing the binary tree=> it is always from top to bottom and left to right
        // data must be level by level
