...
public class EmergencyRoomLII {
    public static void main(String[] args) {
        ...
        queue.offer(new Patient("Bob", 4, LocalDateTime.of(2026, 4, 9, 10, 0)));
        queue.offer(new Patient("John", 1, LocalDateTime.of(2026, 4, 9, 10, 0)));
        queue.offer(new Patient("Jane", 4, LocalDateTime.of(2026, 4, 9, 10, 0)));
        queue.offer(new Patient("Jane", 4, LocalDateTime.of(2026, 4, 9, 10, 0)));
