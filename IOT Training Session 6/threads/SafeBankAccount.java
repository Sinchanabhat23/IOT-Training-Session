...
public class SafeBankAccount {
    ...
    /* the synchronized keyword ensures that only one thread can execute the withdraw() method operation at a time,preventing race condition and ensuring correct balance deduction
    Points to remember
